 ...
 */
    ...
    */
    ...
    {   
        var stringArray = fileText.split("\n");
        var nextArray = [];
        for (var i = 0; i < stringArray.length-1; i++) {
            ...
            nextArray = stringArray[i].split(" ");
            //console.log(Number(nextArray[1]),Number(nextArray[2]),Number(nextArray[3]));
            if (nextArray[0] == "v") {
                this.vBuffer.push(parseFloat(nextArray[1]));
                this.vBuffer.push(parseFloat(nextArray[2]));
                this.vBuffer.push(parseFloat(nextArray[3]));
            }
            if (nextArray[0] == "f") {
                this.fBuffer.push(parseInt(nextArray[2])-1);
                this.fBuffer.push(parseInt(nextArray[3])-1);
                this.fBuffer.push(parseInt(nextArray[4])-1);
            }
        }
